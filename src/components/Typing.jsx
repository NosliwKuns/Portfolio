...
export default function Typing({ ...props }) {
  const { nodes, materials } = useSpline(
    "https://prod.spline.design/xkSIikrhgoiWKQlC/scene.splinecode"
  );
  return (
    <>
      <color attach="background" args={['#f5ded9']} />
      <fog attach="fog" args={['#f5ded9', 1152.44, 2000]} />
      <group {...props} dispose={null} position={[0, 0, 0]} scale={.006}>
        <pointLight
          name="Point Light"
          castShadow
          intensity={0.6}
        ...
        {/* <OrthographicCamera
          ...
          far={500000}
          near={-500000}
          position={[-52.97, 150.02, 987.09]}
          rotation={[-0.21, -0.19, -0.04]}
        /> */}
