...
const  Computers = ({ ...props }) => {
  ...
  const planetOneRef = useRef();
  const planetTwoRef = useRef();

  useFrame((state) => {
    planetOneRef.current.rotation.y += 0.01;
    planetTwoRef.current.rotation.y += 0.01;
  })
  
  return (
    <>
      <group {...props} dispose={null} position={[0, -100, 0]} scale={1}>
        
        <group name="Group 7" position={[-9.5, 25.12, -23.56]}>
          <pointLight
            name="Point Light"
            castShadow
            intensity={1.77}
          ...
          />
          <group name="Planet-with-ring" position={[-173.96, 21.24, -164.62]} ref={planetOneRef}>
            <mesh
              name="Sphere"
          ...
          <mesh
            ...
            scale={100}
          />
          <group name="Group 5" position={[187.81, 76.92, 180.48]} ref={planetTwoRef}>
            <mesh
              name="Sphere002"
